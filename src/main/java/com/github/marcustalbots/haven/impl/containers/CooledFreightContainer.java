 ...
 */
public final class CooledFreightContainer extends AbstractFreightContainer {
     ...
     * @return -1 if the argument is an instance of {@link DefaultFreightContainer}, 0 otherwise.
     * @author Marcus Talbot (1041464)
     * @see HeatedFreightContainer#compareTo(AbstractFreightContainer)
     * @see DefaultFreightContainer#compareTo(AbstractFreightContainer)
     */
    @Override
    public int compareTo(@NotNull AbstractFreightContainer o) {
        return o instanceof DefaultFreightContainer ? -1 : 0;
    }
}
